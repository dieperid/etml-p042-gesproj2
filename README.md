...
#### 1. Open UwAmp and click on ( PHPMyAdmin ) :
...
#### 3. Click on New Database then click on Import :

![NewDataBase](https://user-images.githubusercontent.com/56980502/142626071-339ada73-e36b-4961-8cb4-ebc08977da60.PNG)

#### 4. Click (Chose a file) and use the script ( db_gesProj2.sql ) in [bd-files\sql-scripts] then ( Execute )  : 
